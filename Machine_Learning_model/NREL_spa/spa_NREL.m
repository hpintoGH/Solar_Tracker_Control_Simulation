...
%
% Original last modified: 2017/03/19 - M. Mahooti
%
% MODIFIED BY:
% H. Pinto., 2025/06/12
% Description:
% Adaptation to integrate with the Sun_position code
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [result, spa] = spa_NREL(spa_year, spa_month, spa_day, spa_hour, spa_minute, spa_second, spa_timezone, ...
...
spa.day           = spa_day;
spa.hour          = spa_hour;
spa.minute        = spa_minute;
spa.second        = spa_second;
spa.timezone      = spa_timezone;
spa.delta_ut1     = spa_delta_ut1;
spa.delta_t       = spa_delta_t;
spa.longitude     = spa_longitude;
spa.latitude      = spa_latitude;
spa.elevation     = spa_elevation;
spa.pressure      = spa_pressure;
spa.temperature   = spa_temperature;
spa.slope         = spa_slope;
spa.azm_rotation  = spa_azm_rotation;
spa.atmos_refract = spa_atmos_refract;
spa.function      = spa_function;
