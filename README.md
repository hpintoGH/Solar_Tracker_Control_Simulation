...
2. To start the simulation, open Solar_tracker_simulation.mlx and read the instructions. It is advisable to execute it section by section to prevent potential errors.
...
3. Calculate optimal panel positions using the PVLIB code Irradiation_pvlib.m. Remember that you need all the input variables that the script requires.
